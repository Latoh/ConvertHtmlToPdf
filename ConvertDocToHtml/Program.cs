...
namespace ConvertDocToHtml
{
    class Program
    {
        ...
        public void ConvertSimpleDocToHtml(string sourceFilePath, string destinationFilePath)
        {
            var source = Package.Open(sourceFilePath);
        ...
        public void ConvertDocWithImageToHtml(string sourceFilePath, string destinationFilePath)
        {
            ...
            byte[] data = Encoding.ASCII.GetBytes(htmlText);
